...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/hexalattice-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11507&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hexalattice-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `hexalattice` can be installed with:

```
conda install hexalattice
```

It is possible to list all of the versions of `hexalattice` available on your platform with:
